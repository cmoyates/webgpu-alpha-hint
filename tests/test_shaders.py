...
class TestMorphologyShader:
    ...
    def test_erode_shrinks_dot(self, device):
        ...
        assert eroded_white < original_white, f"Erode should shrink: {original_white} -> {eroded_white}"
    ...
    def test_dilate_grows_dot(self, device):
        ...
        assert dilated_white > original_white, f"Dilate should grow: {original_white} -> {dilated_white}"
